...
export function CenterDashboard() {
  ...
  const stats = [
    ...
    {
      title: 'Pending / Draft',
      value: reportsStats?.draft ?? 0,
      icon: Clock,
      color: 'text-warning',
    },
    {
      title: 'Finalized',
      value: reportsStats?.finalized ?? 0,
      icon: CheckCircle2,
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">
            {org?.name ?? 'Diagnostic Center'}
          </h1>
          <p className="text-muted-foreground text-sm">Center Dashboard</p>
        </div>
        <Badge
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <Button variant="outline" className="w-full justify-start gap-2">
              <FileText className="h-4 w-4" /> Upload New Report
            </Button>
            <Button variant="outline" className="w-full justify-start gap-2">
